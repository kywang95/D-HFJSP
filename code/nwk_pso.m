function [final_best_value, final_best_solution, nfe, cput, totalt, tr] = nwk_pso(t0SA, data,P,PLS,max_nfe, method)
...
%     fprintf('global %d ', gbestval);
    ...
    startvalue = gbestval;
    [pval, J_temp, ls_trend, nfesa] = local_search_sa(t0SA, startvalue, Jbest(idx1,:), data, gbestval, method);
