function [final_best_value, final_best_solution, nfe, cput, totalt, tr] = nwk_ga(t0SA, data, P, max_nfe, method)
...
while cput < max_nfe
    ...
    if cput > max_nfe
        ...
        if rand < pm
            ...
            startvalue = gbestval;
            [newval, newref(j_pos,:), ls_trend, nfesa] = local_search_sa(t0SA, startvalue, refset(B(j_pos), :), data, gbestval, method);
            nfe = nfe + nfesa;
