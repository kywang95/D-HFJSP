function [permutation] = inverse(old_perm,data)
%% swap operator
...
if position_j < position_i
    j = position_j; position_j = position_i; position_i = j;
end
for seq=(position_i+1):(position_j-1)
    permutation(seq) = old_perm(position_i+position_j-seq);
end